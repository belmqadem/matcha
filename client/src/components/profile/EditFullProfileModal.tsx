          ...
          <div className="flex-1 overflow-y-auto overflow-x-hidden p-6 scrollbar-thin">
            ...
            {activeTab === 'identity' && (
              ...
              >
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setIdentityForm((p) => ({ ...p, first_name: e.target.value }))
                      }
                      className={inputCls}
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setIdentityForm((p) => ({ ...p, last_name: e.target.value }))
                      }
                      className={inputCls}
                    />
                  </div>
                ...
                <div className="pt-4">
                  <SaveBar saving={identitySaving} onSave={handleSaveIdentity} onCancel={onClose} />
                </div>
              </form>
            )}
            ...
            {activeTab === 'about' && (
              ...
              >
                ...
                <div className="pt-4">
                  <SaveBar saving={aboutSaving} onSave={handleSaveAbout} onCancel={onClose} />
                </div>
              </form>
            )}
            ...
            {activeTab === 'tags' && (
              ...
              >
                ...
                <div className="pt-4">
                  <SaveBar saving={tagsSaving} onSave={handleSaveTags} onCancel={onClose} />
                </div>
              </form>
            )}
          </div>
