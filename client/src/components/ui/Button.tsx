...
const Button = ({
  ...
  const baseStyles = "w-full flex items-center justify-center gap-2 rounded-full py-2.5 sm:py-3 font-semibold tracking-wider transition-all disabled:opacity-50 disabled:cursor-not-allowed";
