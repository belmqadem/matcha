...
export function FilterSidebar({
  ...
  return (
    <form
      onSubmit={onSubmit}
      className="bg-white rounded-2xl border border-border p-5 shadow-sm flex flex-col gap-5"
    >
      ...
      <div>
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="w-full bg-background border border-border rounded-xl px-3 py-2.5 text-sm outline-none focus:border-primary transition-all text-text"
          />
        ...
        {filters.location_mode === 'km' ? (
          <div className="relative">
            <input
              ...
              className="w-full bg-background border border-border rounded-xl pl-9 pr-3 py-2.5 text-sm outline-none focus:border-primary transition-all text-text"
            />
            <MapPin
              size={13}
      ...
      <div className="flex gap-2 pt-1">
        <button
          type="button"
          onClick={onClear}
          className="flex-1 py-2.5 rounded-xl border border-border text-text-muted text-sm font-bold hover:bg-background transition-colors"
        >
          Clear
        </button>
        <button
          type="submit"
          className="flex-[2] py-2.5 rounded-xl bg-primary text-white text-sm font-black hover:opacity-90 transition-opacity flex items-center justify-center gap-2 shadow-sm"
        >
